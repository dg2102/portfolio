...
const Hero = () => {
  return (
    ...
    >
      ...
      ></video>
      <div className=" h-full z-10 flex flex-col items-center justify-center w-full  px-8 py-8 sm:px-4  md:px-8 lg:px-16 bg-black bg-opacity-0 lg:flex-row lg:gap-36 ">
