...
const Navbar = () => {
  ...
  return (
    <div className="mx-auto flex items-center justify-center relative  ">
      <div className={` h-14 w-full flex fixed top-0 justify-between align-middle items-center ${showBackground ? "bg-black shadow-[0_10px_20px_rgba(240,_46,_170,_0.4)]" : "bg-base-200 shadow-[0_20px_50px_rgba(8,_112,_184,_0.6)]" } rounded-full mx-auto px-16  z-40  border-none text-white  `}>
        <div className="logo">
